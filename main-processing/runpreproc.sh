...
#SBATCH --array=55-650  # run remaining scans with repol option
...
cd ./hcpa
echo $PWD
dwipreproc $DIR/both_encodings_denoised.mif $DIR/dwi_preprocessed.mif -pe_dir AP -rpe_all -eddy_options " --repol --slm=linear --data_is_shelled "
